...
$instore_main_sql="SELECT * FROM twms_instore_main where ism_date < '$migrate_time'";
...
//search and write file
$outstore_main_sql="SELECT * FROM twms_outstore_main where osm_date < '$migrate_time'";
